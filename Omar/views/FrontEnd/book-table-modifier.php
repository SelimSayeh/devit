...
include "../../entites/reservation.php";
							...
							<form method="POST" class="contact-form-area contact-page-form contact-form text-right" id="myForm"  >
								...
								<div class="form-group col-md-12">
									<input type="text" class="form-control" id="datepicker" name="date" placeholder="Select Date & Time" onfocus="this.placeholder = ''"
									 onblur="this.placeholder = 'Select Date & Time'" value="<?PHP echo $date ?>">
								</div>
								<div class="form-group col-md-12">
									<div class="form-select">
										<select id="selectevent" name="event">
											<option value="0"><?PHP echo $event ?>"</option>
											<option value="1">Open bar</option>
											<option value="2">Baila me solar</option>
											<option value="3">Game day</option>
											<option value="4">Bad girls night</option>
											<option value="5">Lions in a box</option>
											<option value="6">A sunday</option>
										</select>
									</div>
								</div>
								<div class="col-lg-12 text-center">
                                        <input  type="submit" class="primary-btn text-uppercase" name="modifier" value="Modifier Reservation">
										<input type="hidden" name="id_in" value="<?PHP echo $_POST['nom'];?>">
...
if (isset($_POST['modifier'])){
	$reservation=new Reservation($_POST['nom'],$_POST['email'],$_POST['tel'],$_POST['nbPeople'],$_POST['date'],$_POST['event']);
    $reservationR->modifierReservation($reservation,$_POST['id_in']);
	echo $_POST['id_in'];
}
   ?>
		</section>
