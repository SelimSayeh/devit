		...
		<div class="container">  
          ...
          <fieldset>
            ...
            <label for="lastName">Adresse: </label>
              <input type="text" tabindex="5" size="22" value=""  name="rue" placeholder="Rue* :"  />

              <input type="text" tabindex="6" size="22" value=""  name="ville" placeholder="Ville* :" />
              
              <input type="number" tabindex="7" size="22" value=""   name="codep" placeholder="Code postal* :"  />
            <br />
