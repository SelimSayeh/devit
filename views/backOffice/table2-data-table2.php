              ...
              <table id="scroll-dynamic" class="display">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><?PHP echo $row['IDJ']; ?></td>
                    <td><?PHP echo $row['NOMJ']; ?></td>
                    <td><?PHP echo $row['MAIL']; ?></td>
                    <td><?PHP echo $row['TELE']; ?></td>
                    
                    <td><form method="POST" action="supprimer2.php">
                      <button type="submit" class="btn btn-danger">Delete</button>
                     <input type="hidden"  name="nomm" value= "<?php echo $row['NOMJ'];?>">
                    </form>
                  </td>
                  </tr>
                   <?php
