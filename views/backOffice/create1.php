	...
	<div class="site-main">
		...
		<div class="container">  
			<div class="login-agileinfo"> 
				...
				<form  name="myForm" method="post" action="ajouterDj.php ">
          
          <fieldset>
            <label for="firstName">id de dj: </label>
            <input type="text" tabindex="1" size="22" value="" name="idj" placeholder="idj :"    class="text" />
            
            <br />
            
            <label for="lastName">nom de dj </label>
            <input type="text" tabindex="2" size="22" value=""  name="nomj" placeholder="nomj :"  title="Ce champ n'accepte que des lettres" data-validation-required-message="Veuillez saisir nom du dj!" class="text" />
            <br />
            
            <label for="lastName">mail: </label>
            <input type="email" tabindex="3" size="22" value=""  name="mail" placeholder="em@il :"  />
            <br />
            
              
            <label for="lastName">tele: </label>
            
            <input type="number" tabindex="4" size="22" value="" name="tele" placeholder="tele :"  class="text" />
            <br />
           
            <div class="clear"></div>
          </fieldset>
          <p>
            <input type="submit" value="Ajouter dj" tabindex="11"onclick="verifa()" name="sinscrire" class="newAccountButton" />
          </p>
