          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Reservations table</h5>
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Home</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Reservation</a>
                  </li>
                  <li class="breadcrumb-item active">Reservations liste
                  </li>
                </ol>
              </div>
              ...
              <table id="scroll-dynamic" class="display">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td><form method="POST" action="supprimerType.php">
