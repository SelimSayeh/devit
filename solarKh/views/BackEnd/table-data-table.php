...
$reservation1R=new ReservationR();
$listeReservations=$reservation1R->afficherReservation();
...
<head>
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns  " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
            <div class="header-search-wrapper hide-on-med-and-down"><i class="material-icons">search</i>
              <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Chercher Reservation">
            </div>
            <!-- translation-button-->
    ...
    <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img src="app-assets/images/logo/Solar.png" alt=""/><span class="logo-text hide-on-med-and-down">solar</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
      </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Tables Reservation</h5>
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Home</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Reservation</a>
                  </li>
                  <li class="breadcrumb-item active">Reservation liste
                  </li>
                </ol>
              </div>
<form method="POST" action="table-data-table-trier.php">
              <div class="col s2 m6 l6"><a href="table-data-table-trier.php" class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right" href="#!" data-target="dropdown1"><i class="material-icons hide-on-med-and-up">settings</i><span class="hide-on-small-onl">Trier</span></a>
              </div>
</form>
            </div>
          </div>
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
          <h4 class="card-title">Solar Normal Reservation Tables
          </h4>
          <div class="row">
            <div class="col s12">
         ...
         <div class="slide-out-right-body">
            <div id="messages" class="col s12">
               <div class="collection border-none">
                  <input class="header-search-input mt-4 mb-2" type="text" id="search" name="Search" onchange="goto()" placeholder="Search Messages" />
