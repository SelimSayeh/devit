<?PHP
include_once "../../core/reservationR.php";
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Table Reservations</h5>
              ...
              <table id="scroll-dynamic" class="display">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                       <form methode="GET" action="../FrontEnd/book-table-modifier.php">
                       <input  type="submit" class="btn btn-secondary" value="Modifier">
                      <input type="hidden" value="<?PHP echo $row['nom']; ?>" name="nom">
                    </form>
                     </td>
                    <td><form method="GET" action="supprimerReservation.php">
