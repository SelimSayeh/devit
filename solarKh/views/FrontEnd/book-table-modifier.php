...
$result=$reservationR->recupererReservation($_GET['nom']);
...
?>
							<form method="POST" class="contact-form-area contact-page-form contact-form text-right" id="myForm" action='modifierReservation.php?modifier&nom=<?PHP echo $nom; ?>&date=<?PHP echo $date; ?> &tel=<?PHP echo $tel; ?>&email=<?PHP echo $email; ?> &event=<?PHP echo $event; ?> &tel=<?PHP echo $tel;?>&nbPeople=<?PHP echo $nbPeople;?>'>
