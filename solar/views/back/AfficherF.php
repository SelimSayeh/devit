  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns  " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li ><a    href="AffecterF.php"><i class="material-icons"></i><span  data-i18n="">Affecter fidelité</span></a>
        <li class="active bold"><a class="waves-effect waves-cyan active " href="AfficherF.php"><i class="material-icons">grid_on</i><span class="menu-title" data-i18n="">Afficher Cartes FID</span></a>
        </li>
        <li class=""><a    href="afficherClients.php"><i class="material-icons"></i><span  data-i18n="">Afficher Clients</span></a> 
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Afficher les Cartes de fidélités</h5>
                
              </div>
              <div class="col s2 m6 l6"><a href="table-data-table2-trier.php" class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right" href="#!" data-target="dropdown1"><i class="material-icons hide-on-med-and-up">settings</i><span class="hide-on-small-onl">Trier</span></a>
              </div>
            </div>
          </div>
        </div>
              ...
              <table id="scroll-dynamic" class="display">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?PHP echo $row['ptsF']; ?></td>
                    <td><form method="POST" action="supprimerF.php" >
                    <td><button  type="submit" class="btn btn-danger">Delete</button>
                      <input type="hidden" value="<?php echo $row['idF']; ?>" name="id">
                    </td>
                    </form>
                  </tr>
                   <?php
