  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns  " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="bold"><a class="waves-effect waves-cyan " href="app-contacts.php"><i class="material-icons">import_contacts</i><span class="menu-title" data-i18n="">Clients</span></a>
        </li>
        ...
        <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">chrome_reader_mode</i><span class="menu-title" data-i18n="">Forms</span></a>
          <div class="collapsible-body">
            <ul class="collapsible collapsible-sub" data-collapsible="accordion">
              ...
              <li class="active"><a class="collapsible-body active" href="form-validation.html" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Creation de la carte de fidélité</span></a>
              </li>
        ...
        <li class="bold"><a class="waves-effect waves-cyan " href="https://pixinvent.com/materialize-material-design-admin-template/documentation/index.html"><i class="material-icons">Clients</i><span class="menu-title" data-i18n="">Documentation</span></a>
        </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Creation de la carte de fidélité</h5>
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Home</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Form</a>
                  </li>
                  <li class="breadcrumb-item active">Creation de la carte de fidélité
                  </li>
                </ol>
              </div>
              <div class="col s2 m6 l6"><a class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right" href="#!" data-target="dropdown1"><i class="material-icons hide-on-med-and-up">settings</i><span class="hide-on-small-onl">Settings</span><i class="material-icons right">arrow_drop_down</i></a>
                <ul class="dropdown-content" id="dropdown1" tabindex="0">
                  ...
                  <li tabindex="0"><a class="grey-text text-darken-2" href="app-contacts.php">Clients</a></li>
      ...
      <div id="html-validations" class="card card-tabs">
        <div class="card-content">
          <div class="card-title">
            <div class="row">
              <div class="col s12 m6 l10">
                <h4 class="card-title">Ajout Carte Fidélité</h4>
              </div>
          ...
          <div id="html-view-validations">
            <form class="formValidate0" id="formValidate0" name="myForm" method="post" action="AjoutF.php">
              <div class="row">
                <div class="input-field col s12">
                  <div class="col s12">
                   <label for="lastName">Date de Creation: </label>
            <input type="date" tabindex="3" size="22" value=""  name="date" placeholder="date de Naissance :"  />
            <br />
                </div>
                <div class="col s12">
                  <label for="role">Cause d'ajout </label>
                  <select class="error validate" id="role" name="Cause" value=""  required>
                    <option value="" disabled selected>Choose add points cause</option>
                    <option value="Reservation">Reservation</option>
                    <option value="Commande d'un produit limité">Commande d'un produit limité</option>
                  </select>
                  <div class="input-field">
                  </div>
                </div>
                <div class="input-field col s12">
                  <textarea id="ccomment0" name="Commentaire" ></textarea>
                  <label for="ccomment0">Commentaire</label>
                </div>
                <div class="col s12">
                <input type="number" tabindex="7" size="22" value=""   name="ptsF" placeholder="Points de fidélité"  />
                ...
                <div class="input-field col s12">
                  <button class="btn waves-effect waves-light right" onclick="verifa2()" type="submit" name="action">Ajouter
                  </button>
                </div>
              </div>
            </form>
