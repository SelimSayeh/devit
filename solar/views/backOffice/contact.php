...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/app-contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 13:10:39 GMT -->
<head>
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns  app-page" data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <!-- BEGIN: SideNav-->
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="active bold"><a class="waves-effect waves-cyan active " href="app-contacts.html"><i class="material-icons">import_contacts</i><span class="menu-title" data-i18n="">Clients</span></a>
        </li>
...
<div id="modal1" class="modal border-radius-6">
  ...
  <div class="modal-footer">
    <a class="btn modal-close waves-effect waves-light mr-2">Clients</a>
  </div>
</div>
    ...
    <div class="sidebar-content">
      <div class="sidebar-header">
        <div class="sidebar-details">
          <h5 class="m-0 sidebar-title"><i class="material-icons app-header-icon text-top">perm_identity</i> Rechercher
          </h5>
          <div class="mt-10 pt-2">
            <p class="m-0 subtitle font-weight-700">Recherche des clients</p>
            <p class="m-0 text-muted">Clients</p>
          </div>
        </div>
      </div>
...
<!-- Content Area Starts -->
  <div class="datatable-search">
      <input type="text" placeholder="Search Contact" name="recherche" class="app-filter" id="global_filter">
    </div>
...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/app-contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 13:10:44 GMT -->
</html>